...
expName = 'RunC_MRI_FaceExperiment'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\SilversLab\\Desktop\\Faces Task\\MRI Task\\RunC_MRI_FaceExperiment.psyexp',
