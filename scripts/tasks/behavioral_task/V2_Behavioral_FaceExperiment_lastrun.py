...
expName = u'V2_Behavioral_FaceExperiment'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/nataliesaragosaharris/Desktop/Ambiguous Faces Task/Behavioral Task/V2_Behavioral_FaceExperiment.psyexp',
...
instructions_1 = visual.TextStim(win=win, name='instructions_1',
    text=u'After each face, you will indicate whether the person in the picture FEELS BAD or FEELS GOOD.\n',
    font=u'Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
...
instructions_2 = visual.TextStim(win=win, name='instructions_2',
    text=u"If you think the person FEELS BAD, press '1'.\n\nIf you think the person FEELS GOOD, press '0'.",
    font=u'Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
...
instructions_3 = visual.TextStim(win=win, name='instructions_3',
    text=u"Make your response quickly, as soon as you see 'FEELS BAD' and 'FEELS GOOD' on the screen.\n\nYou will have 1 second to make your response.\n\nPress the spacebar to begin a practice round.",
    font=u'Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
...
good_or_bad_rating_practice = visual.ImageStim(
    ...
    image=u'Stimuli/bad_or_good.jpg', mask=None,
...
bad_or_good_rating = visual.ImageStim(
    win=win, name='bad_or_good_rating',
    image=u'Stimuli/bad_or_good.jpg', mask=None,
    ori=0, pos=(0, 0), size=(1.5,1.0),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
for thisChooseBlock in ChooseBlock:
    ...
    for thisFacetrial in facetrials:
        ...
        # keep track of which components have finished
        responseComponents = [bad_or_good_rating, good_or_bad_response]
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            # *bad_or_good_rating* updates
            if t >= 0.0 and bad_or_good_rating.status == NOT_STARTED:
                # keep track of start time/frame for later
                bad_or_good_rating.tStart = t
                bad_or_good_rating.frameNStart = frameN  # exact frame index
                bad_or_good_rating.setAutoDraw(True)
            frameRemains = 0.0 + 1.5- win.monitorFramePeriod * 0.75  # most of one frame period left
            if bad_or_good_rating.status == STARTED and t >= frameRemains:
                bad_or_good_rating.setAutoDraw(False)
